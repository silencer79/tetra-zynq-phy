...
initial begin
 ...
 // info=0x3000 / 0x0040. Nach der 2026-05-04 Audit-Korrektur
 ...
 // ------------------------------------------------------------------
 // Cell F18 MN%4-Rotation Tests (bit-genau verifiziert in
 ...
 // -Schedule-Erweiterung gibt F18 TN!=0 MN%4=0 jetzt 0x2249.
 ...
 // ------------------------------------------------------------------
 // 2026-05-02 Erweiterung: Pattern auf TN!=0 nach FN/MN%4
 // ------------------------------------------------------------------
 // TC13 — Audit 2026-05-04: F1-17 TN!=0 idle Traffic-Slot ist
 // konstant 0x3000 (CapAlloc f1=0 f2=0), unabhängig von cell-CC.
 // Vorher Memory `8f679ae` und 1c5d1a8 dokumentierten 0x3CCB / 0x32CB —
 // beides war Drift gegen und wird hier auf 0x3000 korrigiert.
 $display("=== TC13 F1 TN=2 MN%%4=0 → info14=0x3000 (CapAlloc f1=0 f2=0, bit-genau) ===");
