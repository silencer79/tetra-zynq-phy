...
.busy_slots_sys (busy_slots_w)
 ...
 wire [43:0] ref_frag1_w = slice44_from_48(ref_ul0_w);
 ...
 wire [128:0] ref_body_exp_w = {ref_frag1_w, ref_end_hu_w};
 ...
 $display(" ref_frag1[43:0] = 0x%011X (44 bit, expected 0x6634_20C1_226)",
 ref_frag1_w);
 $display(" ref_ul1 hex = D4 1C 3C 02 40 50 2F 4D 61 20 00 00");
 $display(" ref_end_hu[84:0] = 0x%022X", ref_end_hu_w);
 $display(" expected body[128:0] = 0x%033X", ref_body_exp_w);
 $display("------------------------------------------------------------------");
 ...
 drive_frag1(24'h282FF4, ref_frag1_w);
 ...
 // ---------------------------------------------------------------
 // T2: ref frag1 + end_hu within T0, body bit-exact
 // ---------------------------------------------------------------
 ...
 expect_eq129("T2 reass_body_bitexact", reassembled_body_w, ref_body_exp_w);
 ...
 drive_frag1(24'hAAAA01, ref_frag1_w); // → slot 0
 ...
 // Same GSSI-position check for the body (T2 was already run;
