...
// identity / -reference checks against the 102-bit Accept layout.
// =============================================================================
`timescale 1ns / 1ps
...
.pdu_len_bits (pdu_len_bits)
 ...
 // ----- Test 1: MM wrapper output — bit-exact -reference Accept
 // (102 bit MM body): p_ssi=0, p_ae=0, p_sc=0, p_esi=1+ESI(StayAlive),
 // p_scch=0, type-3 GroupIdentityLocationAccept with hard-coded 
 ...
 // GILA payload spans bits 84..27 (58 bits, ref bit-exact).
