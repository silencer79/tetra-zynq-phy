...
module tb_mle_registration_fsm;
    ...
    // Phase H.0.2 — mm=7 group-attach TB stimuli + GAD-ACK staging
    // outputs removed.  Group-Switch flow moved to ARM SW.
    ...
    tetra_mle_registration_fsm #(
        ...
        // Phase H.0.2 — mm=7 group-attach trigger + GAD-ACK staging
        // ports removed (Group-Switch moved to ARM SW).
    );
    ...
    initial begin
        ...
        // -------------------------------------------------------------------
        // Phase H.0.2 (2026-04-27) — mm=7 group-attach test cases removed.
        // Group-Switch flow moved to ARM SW per the FPGA+SW split.  The
        // former T20..T23 (group_attach_3_gssi / replace_all /
        // unknown_gssi / nr_ns_alt) lived here and exercised the FSM
        // `S_GROUP_*` states which are now stripped from the RTL.
        // -------------------------------------------------------------------
