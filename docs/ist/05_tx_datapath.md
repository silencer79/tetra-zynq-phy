...
**Auffälligkeiten:** Stub. Im aktuellen `tetra_dl_pdu_builder.v` hardcoded `capacity_allocation=0, granting_delay=0` (Kommentar nennt "Match per project_slot_grant_drift.md").
...
**Auffälligkeiten:**
- Hardcoded für CMCE-Pfad (`lat_mle_pd == 3'b010`): `slot_granting_flag=0`, `chan_alloc_flag=1`, `chan_alloc_element=32'h0027_2FD3`, `chan_alloc_element_len=25`, `usage_marker=11`. Kommentar markiert "Phase 7 G.5+ — spec-konformes MAC-RESOURCE-Header für CMCE".
