...
2. RTL-Sourcen-Add:
 ...
 - **LMAC (30+):** `tetra_lmac.v`, `tetra_scrambler.v`, `tetra_interleaver.v`, `tetra_deinterleaver.v`, `tetra_depuncture_r23.v`, `tetra_rcpc_encoder.v`, `tetra_viterbi_decoder.v`, `tetra_reed_muller.v`, `tetra_crc16.v`, `tetra_steal_detect.v`, `tetra_ul_mac_access_parser.v`, `tetra_d_location_update_encoder.v`, `tetra_d_location_update_reject_encoder.v`, `tetra_sch_hd_encoder.v`, `tetra_sch_f_encoder.v`, `tetra_basic_slotgrant_encoder.v`, `tetra_chan_alloc_encoder.v`, `tetra_mac_resource_dl_builder.v`, `tetra_mac_resource_bl_ack_builder.v`, `tetra_mle_registration_fsm.v`, `tetra_dl_signal_queue.v`, `tetra_dl_signal_scheduler.v`, `tetra_ul_demand_ie_parser.v`, `tetra_dl_nwrk_broadcast.v`, `tetra_indirect_mailbox.v`, `tetra_indirect_mailbox_wr.v`, `tetra_demand_mailbox.v`, `tetra_reply_mailbox.v`, `tetra_grp_demand_mailbox.v`, `tetra_voice_filler_mailbox.v` (Phase 7 G.8, DL voice-slot), `tetra_voice_nub_read_mailbox.v` (Phase C, UL NUB SW-pipe), `tetra_pre_reply_blck.v`, `tetra_pre_reply_slotgrant.v`, `tetra_dl_pdu_builder.v`.
