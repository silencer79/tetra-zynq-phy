 ...
 * -reference layout captured in
 * `memory/removed-memory` (1-record case
 * verified bit-genau against Capture cycle GS#1).
 *
 ...
 * addr_type (2) 0=SSI/GSSI (only addr_type=0 used in )
 * GSSI (24) MSB-first
 ...
 *
 * Ref 1-record case (GS#1, GSSI=0x2F4D64, class=4, lifetime=1, atd=0):
