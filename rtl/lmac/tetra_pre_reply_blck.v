...
//
// This corresponds to Step 4 of the -ITSI-Attach sequence
// (removed-memory): BS BL-ACK after Frag-2.
...
// Step 4 and broke spec-conformance; the trigger has been moved to
// the post-reassembly pulse.
//
// Per Ref `removed-memory` the post-Frag-2
...
module tetra_pre_reply_blck (
 ...
 // This is Step 4 of the ITSI-Attach sequence.
