...
//
// Bit-exact replica of the 2026-04-25 -reference Accept (Burst #735 in
...
// [ 84: 27] GILA payload 58 (-ref: bit-exact replica
...
: PDU_TYPE_LOC_ACCEPT;
 ...
 // -------------------------------------------------------------------------
 // GILA payload (58 bit) — bit-exact replica of the external-BS 
 ...
 //
 // See ~/.claude/.../memory/removed-memory for the
 // ref bit pattern.
 // -------------------------------------------------------------------------
