...
echo "     scp $BIN_FILE root@192.168.2.85:/lib/firmware/tetra/"
echo ""
echo "  2. Load via FPGA Manager:"
echo "     ssh root@192.168.2.85 'echo tetra/${BITSTREAM}.bit.bin > /sys/class/fpga_manager/fpga0/firmware'"
echo "     ssh root@192.168.2.85 'echo 1 > /sys/class/fpga_manager/fpga0/flags'"
echo ""
