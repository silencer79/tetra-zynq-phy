...
# Constraints
add_files -fileset constrs_1 -norecurse $PROJ_DIR/constraints/libresdr_tetra.xdc
...
#
# Flow: MARK_DEBUG marks nets; we must manually create ILA cores via
# create_debug_core / connect_debug_port, then call implement_debug_core.
# The design must also be re-opened from a checkpoint first (Vivado quirk).
#
# Net naming convention (from tetra_zynq_top.v):
#   *_lvds → l_clk domain  (AD9361 DATA_CLK)
#   *_sys  → clk_sys domain (PL fabric 100 MHz)
# =============================================================================
